...
export const SEventBannerContentTitle = styled.h3`
   ${tw`text-app-font-16 text-app-color-white uppercase font-bold flex-none app-max-width-extra-small:text-app-font-10 app-max-width-small:text-app-font-12`}
`;
